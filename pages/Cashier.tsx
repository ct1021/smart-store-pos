...
const Cashier: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-100 dark:bg-zinc-950 transition-colors duration-300 relative">
        ...
        {/* Bottom Bar */}
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] z-30 pb-safe">
